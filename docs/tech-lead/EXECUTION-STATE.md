...
- R1-003 (protocol registry and cross-language harness) — READY, owner W1.
- R1-004 (signed capabilities/admission) — READY, owner W1.
- R2-004 (transport quality telemetry) — READY, owner W2.
- Worker 3: still idle (next W3-eligible items are wave 7+).
